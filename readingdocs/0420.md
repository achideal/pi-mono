...
11. [持久化机制：message_end 时发生了什么](#11-持久化机制message_end-时发生了什么)
12. [TypeScript 函数重载](#12-typescript-函数重载)
13. [createAgentSession：工厂函数与启动流程](#13-createagentsession工厂函数与启动流程)
14. [Agent 构造参数的溯源](#14-agent-构造参数的溯源)
...
## 13. createAgentSession：工厂函数与启动流程
